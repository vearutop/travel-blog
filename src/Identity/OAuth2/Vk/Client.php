...
namespace TravelBlog\Identity\OAuth2\Vk;



class Client
{
    public function __construct($appId = null, $redirectUri = null) {
        $this->appId = $appId;
    ...
    private $display = self::DISPLAY_PAGE;
    ...
    public function getAuthUri($back = null) {
